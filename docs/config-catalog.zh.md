...
- `@deepseek-ai/dsh-client-ui-overlay`（[`packages/client/ui-overlay/src/index.ts`](../packages/client/ui-overlay/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-stock-actions`（[`packages/client/ui-stock-actions/src/index.ts`](../packages/client/ui-stock-actions/src/index.ts)）
